...
layui.define(['jquery', 'form'], function(exports){
    ...
    var obj = {
        ...
        render: function(dst, trees, opt) {
            ...
            // 自动取消选中
            if(opt.autoclose !== undefined && opt.autoclose !== 'undefined'){
                obj.autoclose = opt.autoclose;
            }
            opt.autoclose = obj.autoclose;
            // 自动选择直属父级节点
            if(opt.autochecked !== undefined && opt.autochecked !== 'undefined'){
                obj.autochecked = opt.autochecked;
            }
            opt.autochecked = obj.autochecked;
            ...
            opt.valueKey = opt.valueKey ? opt.valueKey : 'key';
